...
<div class="input-card text-center">
    ...
    <input type="text" placeholder="Enter username" class="input uname" name="username">
    <input type="password" placeholder="********" class="input password"  name="password"> 
    <button class="btn" type="submit" name="submit1" >Login Now</button>  
...
if(isset($_POST['submit1'])){
    ...
    $check = " Select * from users2 where username = '$username' and password = '$password' ";
    // echo $check;
