...
<body>
    <nav> 
        <!-- <a href=""><img src="<a href="https://iconscout.com/icons/facebook" class="text-underline font-size-sm" target="_blank">facebook</a> by <a href="https://iconscout.com/contributors/maninderkaur" class="text-underline font-size-sm" target="_blank">maninderkaur</a>" alt=""></a> -->
       <a class="logo" href=""> 
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
       ...
       <div class="links">
        ...
        <a href="">Friends</a> 
        <a href="" class="signup-btn">Create your Account</a>
       </div>
    </nav>

    <div class="story-container">
        <img src="https://source.unsplash.com/900x900/?baby" alt="" class="story">
        <img src="https://source.unsplash.com/900x900/?gragon" alt="" class="story">
        <img src="https://source.unsplash.com/900x900/?soldier" alt="" class="story">
        <img src="https://source.unsplash.com/900x900/?ram" alt="" class="story">
        <img src="https://source.unsplash.com/900x900/?cat" alt="" class="story">
    </div>
    <div class="container">
        <div class="feed">
            <div class="card">
                <div class="user-details">
                    <img src="https://source.unsplash.com/900x900/?student" class="user-img" alt="">
                    <div class="">
                        <h5 class="name">Aditi Pandey</h5>
                        <p class="username">@adu</p> 
                    </div>
                </div>
                <div class="card-header">
                    <img src="https://source.unsplash.com/1600x900/?india" class="card-img" alt="">
                    <p class="tag">398 Likes</p>
                </div>
                <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta accusamus fugiat
                    laborum dolor
                    et tenetur repellat?</p>

                <div class="icons">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                        class="bi bi-heart" style="color: red;" viewBox="0 0 16 16">
                        <path
                            d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                        class="bi bi-chat-left-dots" style="color: green;" viewBox="0 0 16 16">
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                        class="bi bi-box-arrow-up-right" style="color: gray;" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                        class="bi bi-bookmark" style="color: blue;" viewBox="0 0 16 16">
                        <path
            ...
            <div class="card">
                <div class="user-details">
                    <img src="https://source.unsplash.com/900x900/?coder" class="user-img" alt="">
                    <div class="">
                        <h5 class="name">Divyansh Mishra</h5>
                        <p class="username">@divyansh</p>
                    </div>
                </div>
                <div class="card-header">
                    <img src="https://source.unsplash.com/1600x1200/?mountains" class="card-img" alt="">
                    <p class="tag">398 Likes</p>
                </div>
                <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta accusamus fugiat
                    laborum dolor
            ...
            <div class="card">
                <div class="user-details">
                    <img src="https://source.unsplash.com/900x900/?user" class="user-img" alt="">
                    <div class="">
                        <h5 class="name">yash goel</h5>
                        <p class="username">@yash</p>
                    </div>
                </div>
                <div class="card-header">
                    <img src="https://source.unsplash.com/1600x900/?running" class="card-img" alt="">
                    <p class="tag">98 Likes</p>
                </div>
                <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta accusamus fugiat
                    laborum dolor
                    et tenetur repellat?</p>
        ...
        <div class="sidebar">
                <h3>Download our app for amazing experience</h3>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Assumenda natus expedita vero dolorem unde nam veritatis. Amet, quas!</p>
        
            <div class="app">
                <a href=""><img src="./img/icon-AppStore_lg30tv.webp" alt=""></a>
                <a href=""><img src="./img/icon-GooglePlay_1_zixjxl.webp" alt=""></a>  
            </div>
